...
/**
 * Unicorn of One - Dynamic Agent Orchestrator
 * 
 * Template for creating orchestrators for other "Of One" sites.
 * Replace Unicorn of One, Ambitious founders aiming for massive scale without massive teams, and customize TASK_REGISTRY.
 */
...
const SITE_CONFIG = {
  name: 'Unicorn of One',  // e.g., 'Director of One'
  domain: 'unicornofone.ai',   // e.g., 'directorofone.ai'
  targetAudience: 'Ambitious founders aiming for massive scale without massive teams', // e.g., 'one-person department managers'
  primaryColor: '#4169E1',  // Utlyze blue (keep consistent)
  accentColor: '#8E44AD',  // Customize per site type
};
...
const TASK_REGISTRY = {
  ...
  'content-strategy': {
    ...
    estimatedHours: 4,
    priority: 'CRITICAL',
    prompt: `Create content for ${SITE_CONFIG.name}. Target: ${SITE_CONFIG.targetAudience}. Pain points: World-changing idea but no world-sized team, Traditional wisdom says you can't do it alone, Burning out before breaking through, Losing focus across too many priorities. Solution: Radical focus methodology and AI leverage for exponential growth. Focus on Exponential productivity systems, AI-powered scaling strategies, Focus on 10x opportunities only, Elite founder community access.`,
